...
test( "constructor", function () {
	...
	var rect1 = new $.fracs.internal.Rect( 30, 50, 400, 300 );
	...
	var rect2 = new $.fracs.internal.Rect( 30.1, 50.4, 400.3, 299.5 );
...
test( "equals", function () {
	...
	var rect1 = new $.fracs.internal.Rect( 30, 50, 400, 300 );
	var rect2 = new $.fracs.internal.Rect( 30.1, 50.4, 400.3, 299.5 );
	var rect3 = new $.fracs.internal.Rect( 100, 200, 400, 300 );
...
test( "intersection", function () {
	...
	var rect1 = new $.fracs.internal.Rect( 30, 50, 400, 300 );
	var rect2 = new $.fracs.internal.Rect( 100, 200, 400, 300 );
	var intersection = new $.fracs.internal.Rect( 100, 200, 330, 150 );
...
test( "envelope", function () {
	...
	var rect1 = new $.fracs.internal.Rect( 30, 50, 400, 300 );
	var rect2 = new $.fracs.internal.Rect( 100, 200, 400, 300 );
	var envelope = new $.fracs.internal.Rect( 30, 50, 470, 450 );
